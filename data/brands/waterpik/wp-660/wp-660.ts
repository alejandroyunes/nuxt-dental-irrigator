...
const waterpikwp660: ProductDetails = {
  info: {
    ...
    description: "The Waterpik Aquarius Water Flosser WP 660 is a professional-grade dental care device designed for teeth, gums, and braces. It features 10 pressure settings, a massage mode for gum stimulation, and a built-in timer/pacer. It includes a large 650 ml reservoir for over 90 seconds of use, a maneuverable flossing wand, and a convenient water on/off switch. It's the #1 water flosser brand recommended by dental professionals and the first to earn the American Dental Association (ADA) Seal of Acceptance.",
